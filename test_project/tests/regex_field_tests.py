...
class RegexFieldTest(TestCase):
    ...
    def test_without_south(self):
        ...
        self.assertNotEquals(test_obj.regex.match('a'), None)
        self.assertEquals(test_obj.regex.match('b'), None)
    ...
    def test_blank(self):
        ...
        self.assertEquals(test_obj.regex, re.compile(''))
    ...
    def test_save_str(self):
        ...
        self.assertNotEquals(test_obj.regex.match('z'), None)
        self.assertEquals(test_obj.regex.match('b'), None)
